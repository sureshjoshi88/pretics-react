  ...
  return (
    <div className='flex justify-center'>
      ...
      <div className='flex justify-between mt-10'>
        <button onClick={counter} className='bg-sky-300 p-2 rounded font-bold hover:bg-sky-500'>Like <i class="fa-solid fa-thumbs-up" style="color: #0d0d0d;"></i></button>
        <button onClick={counter2} className='bg-sky-300 p-2 rounded font-bold hover:bg-sky-500'>Dislike <i class="fa-solid fa-thumbs-down" style="color: #121212;"></i></button>

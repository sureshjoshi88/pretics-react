        ...
        <div className="bg-white rounded shadow-xl p-2 mt-3 ">
          ...
          <div className='flex justify-between mt-3 gap-5 w-80'>
            <div className="flex items-center">
              <div onClick={counter} className="text-3xl text-green-700">
                <AiFillLike />
              </div>
              <button className='w-10 text-2xl' id='buton-1'>{like}</button>
            </div>
            <div className="flex items-center">
              <div onClick={counter2} className="text-3xl text-red-700">
                <AiFillDislike />
              </div>
              <button className='w-10 text-2xl' id='buton-2'>{dislike}</button>
            </div>
            <button onClick={reset} className='text-3xl text-lime-600'><GrPowerReset />
            </button>          </div>
          <div className="flex gap-2 mt-3 border w-fit rounded">
            ...
            <div className="text-2xl text-neutral-700"  onClick={buttons}><GiPlayButton /></div>
          </div>
